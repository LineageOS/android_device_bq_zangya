...
PRODUCT_BUILD_PROP_OVERRIDES += \
        PRODUCT_NAME=zangya \
        PRIVATE_BUILD_DESC="zangya_bq-user 9 PKQ1.190118.001 300 release-keys"

BUILD_FINGERPRINT := bq/zangya_bq/zangya_sprout:9/PKQ1.190118.001/300:user/release-keys
